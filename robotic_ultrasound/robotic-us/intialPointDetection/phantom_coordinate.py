...
class PhatomCoordinate:
    def __init__(self, image_topic=None):
        ...
        self.camera_intrinsic = np.array([[615.7256469726562, 0.0, 323.13262939453125],
                            ...
                            [0.0, 0.0, 1.0]])
        # # publish segmented image to which topic?
        # self.publish_seg_image = rospy.Publisher(name=image_topic, data_class=Image, queue_size=2)
...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ...
        if starting_point and direction_point:
            ...
            print(f'final homogeneous matrix: \n{final_mat}\n\n')
        rate.sleep()        
