...
class Rs2ArucoDetector:
    ...
    def detect_aruco(self, cv2_img):
        ...
        parameters = aruco.DetectorParameters_create()  # version 4.5.4
        # parameters = aruco.DetectorParameters() # version 4.7.0-dev
        ...
        if np.all(ids != None):
            ...
            rvec, tvec, _ = aruco.estimatePoseSingleMarkers(corners, self.marker_length, (self.mtx), (self.dist))
    ...
    def detect_charuco(self, cv2_img):
        ...
        charuco_board = aruco.CharucoBoard_create( # version 4.5.4
            squaresX=5, squaresY=5, squareLength=0.02, markerLength=0.016, dictionary=aruco_dict
        )
