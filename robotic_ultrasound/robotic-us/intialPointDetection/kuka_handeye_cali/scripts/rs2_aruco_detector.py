...
class Rs2ArucoDetector:
    def __init__(self, 
        ...
        self.cinfo_sub = rospy.Subscriber("/camera/color/camera_info", CameraInfo, self.cinfo_sub_cb) # intern parameters
    ...
    def detect_charuco(self, cv2_img):
        ...
        charuco_board = aruco.CharucoBoard_create(squaresX=5, squaresY=5, squareLength=0.02, markerLength=0.016, dictionary=aruco_dict)
