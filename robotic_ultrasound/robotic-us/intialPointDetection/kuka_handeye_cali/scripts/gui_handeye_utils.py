...
class CaliSampler():
    def __init__(self, 
        ...
        print('CaliSampler: waiting_for_message: /iiwa/move_group/status')
        rospy.wait_for_message('/iiwa/move_group/status', GoalStatusArray)
        print('CaliSampler: /iiwa/move_group/status okay!')
...
class CaliCompute():
    '''
    Description: 
        The CaliCompute would load the sample from a file with predefined format or 
    ...
    def push_back_sample_buffer(self, ee2base_trans:list, 
        ...
        '''
        Description: 
            get the translation (position) of the end-effector and aruco/charuco,
